...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener
{
	...
	public void init()
	{
		...
		if( !ValveActivity2.preInit( this, getIntent() ) )
		{
			...
			dlgAlert.setNegativeButton( R.string.srceng_launcher_set, (dialog, id) -> {
			...
			dlgAlert.setPositiveButton( R.string.srceng_launcher_ok, (dialog, id) -> mSingleton.finish());
			dlgAlert.setCancelable( false );
			dlgAlert.create().show();
		...
		{
			// Android 4.4 to Android 10 - use legacy fullscreen flags
			int flags = View.SYSTEM_UI_FLAG_FULLSCREEN | View.SYSTEM_UI_FLAG_HIDE_NAVIGATION | View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION | View.SYSTEM_UI_FLAG_LAYOUT_STABLE | View.INVISIBLE;
	...
	public boolean dispatchKeyEvent( KeyEvent event )
	{
		...
		if( keyCode == KeyEvent.KEYCODE_VOLUME_DOWN || keyCode == KeyEvent.KEYCODE_VOLUME_UP || keyCode == KeyEvent.KEYCODE_CAMERA || keyCode == KeyEvent.KEYCODE_ZOOM_IN || /* API 11 */
	 ...
	 */
	public int messageboxShowMessageBox( final int flags, final String title, final String message, final int[] buttonFlags, final int[] buttonIds, final String[] buttonTexts, final int[] colors )
	{
...
class DummyEdit extends View implements View.OnKeyListener
{
	...
	public InputConnection onCreateInputConnection( EditorInfo outAttrs )
	{
		...
		outAttrs.imeOptions = EditorInfo.IME_FLAG_NO_EXTRACT_UI | EditorInfo.IME_FLAG_NO_FULLSCREEN /* API 11 */;
...
class SDLInputConnection extends BaseInputConnection
{
	...
	public boolean deleteSurroundingText( int beforeLength, int afterLength )
	{
		...
		if( beforeLength > 0 && afterLength == 0 )
		{
			...
			{
				boolean ret_key = sendKeyEvent( new KeyEvent( KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_DEL ) ) && sendKeyEvent( new KeyEvent( KeyEvent.ACTION_UP, KeyEvent.KEYCODE_DEL ) );
				ret = ret && ret_key;
			}
			return ret;
		}
